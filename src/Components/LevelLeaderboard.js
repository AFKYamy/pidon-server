  ...
  return (
      <div className="level-leaderboard">
        <div className="level-leaderboard__wrapper">
            ...
            <LevelPlayer img="/Images/devil-head.png" name="DevilNo9" level="3339" />
            <span></span>
            <LevelPlayer img="/Images/gemtik-head.png" name="GEMTIkcz" level="229" />
            <span></span>
            <LevelPlayer img="/Images/manie-head.png" name="Manie_cz" level="19" />
